<template>
  <v-stepper v-model="currentStep">
    <v-stepper-header>
      <v-stepper-step :color="'#02bb8ccc'" :complete="currentStep > 1" step="1">
        {{ $t('recover_password.validate_email') }}
      </v-stepper-step>

      <v-divider></v-divider>

      <v-stepper-step :color="'#02bb8ccc'" :complete="currentStep > 2" step="2">
        {{ $t('recover_password.validate_codigo') }}
      </v-stepper-step>

      <v-divider></v-divider>

      <v-stepper-step :color="'#02bb8ccc'" step="3">
